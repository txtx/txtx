...
/// and basic validation. It does **NOT** include the enhanced validation that the `lint`
/// command provides:
///
...
/// - Quick validation tests that don't need full linter analysis
///
/// # When NOT to Use
///
/// Keep integration tests for:
/// - Testing lint command's enhanced validation

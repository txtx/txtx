...
use txtx_addon_kit::types::{
    diagnostics::Diagnostic, frontend::ActionItemRequest, types::Value,
    wallets::WalletSpecification, ConstructUuid,
};
...
pub async fn get_addition_actions_for_address(
    ...
    // let evm_rpc = EVMRpc::new(&rpc_api_url);
    ...
    //         let (action_status, value) = match evm_rpc.get_balance(&expected_address).await {
    //             Ok(response) => (
    //                 ActionItemStatus::Todo,

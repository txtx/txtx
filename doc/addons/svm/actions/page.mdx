...
<Properties>
  ...
  - **include_owned_accounts**: Whether to recursively delete all accounts owned by this account. Default is false.
  </Property>


  <Property name="stream_account" required="optional" type="map">
    The account stream data to set. This is a map type containing the keys:
  - **public_key**: The public key of the account to stream.
  - **include_owned_accounts**: Whether to recursively stream all accounts owned by this account. Default is false.
  </Property>

...
<Properties>
  ...
  <Property name="program_id" required="required" type="string | addon(svm::pubkey)">
...
<Properties>
  ...
  <Property name="wallet_address" required="required" type="string | addon(svm::pubkey)">
    The address of the wallet to compute the associated token account for.
  </Property>


  <Property name="token_mint_address" required="optional" type="string | addon(svm::pubkey)">
...
<Properties>
  ...
  <Property name="funding_address" required="required" type="string | addon(svm::pubkey)">
  ...
  <Property name="token_program_id" required="optional" type="string | addon(svm::pubkey)">
...
<Properties>
  ...
  <Property name="value" required="required" type="integer">
    The u64 integer to convert to a byte array.
  </Property>
...
<Properties>
  <Property name="value" type="buffer">
    The byte array representation of the provided u64 integer.
  </Property>
</Properties>


<CodeGroup title="Example using u64">
...
`svm::i64` creates a byte array representation of a i64 integer, suitable for use as a seed in PDA derivation.
...
<Properties>
  ...
  <Property name="value" required="required" type="integer">
    The i64 integer to convert to a byte array.
  </Property>
...
<Properties>
  <Property name="value" type="buffer">
    The byte array representation of the provided i64 integer.
  </Property>
</Properties>


<CodeGroup title="Example using i64">

export const metadata = {
    title: "Ethereum and EVM Compatible Blockchains (alpha) Wallets",
    description: "Wallets for Ethereum and EVM Compatible Blockchains (alpha)",
};

# Ethereum and EVM Compatible Blockchains (alpha) Wallets {{ id: "evm-wallets" }}



## mnemonic {{ tag: 'wallet' }}

The `evm::mnemonic` wallet can be used to synchronously sign a transaction.

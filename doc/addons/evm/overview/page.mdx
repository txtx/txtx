export const metadata = {
    title: "Ethereum and EVM Compatible Blockchains (alpha)",
    description: "Add-on for Ethereum and EVM Compatible Blockchains (alpha)",
};

# Ethereum and EVM Compatible Blockchains (alpha) {{ id: "evm-constructs" }}

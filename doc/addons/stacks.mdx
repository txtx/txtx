...
<Properties>
  ...
  <Property name="confirmations" type="optional">
    Coming soon - once the transaction is included on a block, the number of blocks to await before the transaction is considered successful.
  </Property>
...
The `call_readonly_fn` action queries public functions.
...
<Properties>
  ...
  <Property name="contract_id" type="required">
    Address and identifier of the contract to invoke
  </Property>
...
When the `` action is successfully executed, the following outputs are attached to the action
...
<Properties>
  ...
  <Property name="expected_public_key" type="">
    Coming soon
  </Property>
...
<Properties>
  ...
  <Property name="exepcted_address" type="">
    Coming soon
  </Property>


  <Property name="exepcted_public_key" type="">
    Coming soon
  </Property>

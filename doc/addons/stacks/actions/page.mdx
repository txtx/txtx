...
<Properties>
  ...
  <Property name="contracts_ids_dependencies" type="optional">
    Contracts that are depending on this contract at their deployment.
  </Property>


  <Property name="contracts_ids_lazy_dependencies" type="optional">
...
## deploy_contract_requirement {{ tag: 'action' }}
...
When the `deploy_contract_requirement` action is successfully executed, the following outputs are attached to the action
...
<CodeGroup title="Example using deploy_contract_requirement">

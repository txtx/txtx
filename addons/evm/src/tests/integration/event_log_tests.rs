...
mod event_log_tests {
    ...
    fn test_deploy_and_get_logs() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute event log test");
    ...
    fn test_get_receipt_logs() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute receipt log test");
    ...
    #[test]
    fn test_filter_logs_by_block_range() {
        if !AnvilInstance::is_available() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute block range filter test");
    ...
    fn test_parse_event_data() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute event parsing test");

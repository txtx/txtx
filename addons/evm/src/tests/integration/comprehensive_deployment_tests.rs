...
mod comprehensive_deployment_tests {
    ...
    #[test]
    fn test_factory_pattern_deployment() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute factory deployment");
    ...
    #[test]
    fn test_proxy_upgradeable_deployment() {
        if !AnvilInstance::is_available() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute proxy deployment");
    ...
    fn test_large_contract_deployment() {
        ...
        let large_bytecode = "0x608060405234801561001057600080fd5b50" + &"60".repeat(20000) + "806100206000396000f3fe";
    ...
    fn test_batch_deployment() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute batch deployment");
    ...
    fn test_deterministic_deployment() {
        ...
        let result = harness.execute_runbook()
            .expect("Failed to execute CREATE2 deployment");
